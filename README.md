...
A:This project will not support English. All the following instructions will be based on Chinese. I hope you can use a
translator yourself. If you come across any sentences that you don't understand, why not ask the GPT for help?
...
Q:原神怎么你了？  
A:
你说得对，但是呢，那个，就是……就是那个两个字的游戏，它那个，嗯，他是由那个，好像是三个字的那个什么公司，自主，啊，研发的一款…全新的，开放的，那个叫做什么的冒险，的游戏。这个游戏发生在一个…一个被称作，被称作…三个字的，的一个幻想的世界，然后就是呃呃啊啊啊我又忘了
重要的游戏，绝不能忘记的游戏
...
T:It is not uncommon for misinformation to lead to financial deception, as seen in cases where AI painting packages are
frequently sold.  
If you disapprove of unscrupulous merchants profiting from such practices, you have the option to support my project by
giving it a favorable rating and promoting it through engaging with my Bilibili video, thereby increasing awareness of
this free and open-source script. A simple action that could make a substantial difference (laughs).  
...
| Harrier               | 0     | 如果是鹞式，请把这个改为1。丢完炸弹以后会将油门减少10%左右(如果是加力状态减少到95%左右)                                                                                                   |
...
| 节流阀控制                 | 0     | 是否开启节流阀控制，1开启，0关闭                                                                                                                                  |
| 节流阀范围                 | 90,95 | 节流阀控制范围。请注意！这个控制与上面的限速以及鹞式判断均无关，是单独的设定                                                                                                             |
| 加力模式                  | 1     | 如果是不需要加力或者没有加力的飞机，请改为0，有则改为1                                                                                                                       |
