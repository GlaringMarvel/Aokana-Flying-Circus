...
| decelerate            | -1  | 离战区多少公里开始开启减速板（-1代表不开启减速板。这个距离和飞机的飞行高度和速度有关，自己根据飞机调整，单位是公里）                                                                                        |
...
| mode                  | 2   | 飞行模式（模式1：扔完炸弹以后直奔对面机场。模式2：扔完炸弹以后会随机选取一个战区方向开始逛街，到达后切换战区继续逛街）                                                                                       |
