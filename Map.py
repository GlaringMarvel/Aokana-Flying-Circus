...
def foundMap():
    ...
    if md5 == NoMap:
        print("非战斗中")
        map_found = 0
        return h1, h2, v1, v2, v3, number, map_found
    elif md5 is None:
        print("正在加载")
        map_found = 2
        return h1, h2, v1, v2, v3, number, map_found
        ...
        print("地图 越南")
        h1, h2, v1, v2, v3, number = mapData('Vietnam')
        return h1, h2, v1, v2, v3, number, map_found
    elif md5 == SinaiPeninsula:
        print("地图 西奈半岛")
        h1, h2, v1, v2, v3, number = mapData('SinaiPeninsula')
        return h1, h2, v1, v2, v3, number, map_found
    elif md5 == GolanHeights:
        print("地图 戈兰高地")
        h1, h2, v1, v2, v3, number = mapData('GolanHeights')
        return h1, h2, v1, v2, v3, number, map_found
    elif md5 == Spain:
        print("地图 西班牙")
        h1, h2, v1, v2, v3, number = mapData('Spain')
        return h1, h2, v1, v2, v3, number, map_found
    elif md5 == PyreneesMountains:
        print("地图 比利牛斯山脉")
        h1, h2, v1, v2, v3, number = mapData('PyreneesMountains')
        return h1, h2, v1, v2, v3, number, map_found
    elif md5 == BigCity:
        print("地图 大都会")
        h1, h2, v1, v2, v3, number = mapData('BigCity')
        return h1, h2, v1, v2, v3, number, map_found
    elif md5 == Afghanistan:
        print("地图 阿富汗")
        h1, h2, v1, v2, v3, number = mapData('Afghanistan')
        return h1, h2, v1, v2, v3, number, map_found
    else:
        return h1, h2, v1, v2, v3, number, map_found
